...
:: Android packaging
set AND_CERT_NAME="try_starling"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\trystarling.p12
...
set IOS_PROVISION=cert\trystarling.mobileprovision
...
set APP_ID=air.trystarling

:: Output packages
set DIST_PATH=dist
set DIST_NAME=trystarling
